...
print("<h5>ACCOUNTS NOT FOLLOWING BACK:</h5>Click the button to visit the profile", end = "</br></br>")
for account_check in following_list_stored:
    if account_check not in follower_list_stored:
        print("<a href=\\\"https://www.instagram.com/"+account_check+"\\\" class=\\\"btn btn-outline-secondary\\\" role=\\\"button\\\" target=\\\"_blank\\\">"+account_check+"</a>", end="</br>")
